document.addEventListener('DOMContentLoaded', () => {
    ...
    function validatePassword() {
        ...
        if (!passwordValue) {
            ...
            passwordError.textContent = "Sua senha deve conter números!";
            passwordField.classList.add('error');
        } else if (!passwordValue.match(/[A-Z]/)){
            passwordError.textContent = "Sua senha deve conter um caractere maiúsculo!";
            passwordField.classList.add('error');
        } else if (!passwordValue.match(/[$*&@#!%^&*()\-_+=]/)){
            passwordError.textContent = "Sua senha deve conter um caractere especial!";
            passwordField.classList.add('error');
        } else {
    ...
    document.querySelector('.login').addEventListener('click', toggleLoginBox);
